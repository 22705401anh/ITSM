...
async def assets_detail(request: Request, asset_id: int):
    """Asset detail page."""
    return templates.TemplateResponse(request, "assets/detail.html", {"asset_id": asset_id})


@router.get("/assets/{asset_id}/edit", response_class=HTMLResponse)
async def assets_edit(request: Request, asset_id: int):
    """Edit asset page."""
    return templates.TemplateResponse(request, "assets/edit.html", {"asset_id": asset_id})
...
async def hardware_detail(request: Request, asset_type: str, asset_id: int):
    ...
    return templates.TemplateResponse(request, "assets/hardware_detail.html", {"asset_type": asset_type, "asset_id": asset_id})
